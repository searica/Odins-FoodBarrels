...
namespace OdinsFoodBarrels
{
    ...
    public class OdinsFoodBarrelsPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            OH_Raspberries.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Blue_Mushrooms.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Blueberries.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Carrots.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_CloudBerries.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Fish.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Honey.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Red_Mushrooms.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Turnips.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Yellow_Mushrooms.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Thistle.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Dandelion.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Barley.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Flax.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Onions.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Egg_Basket.Category.Add(BuildPieceCategory.Misc);

            BuildPiece OH_JotunPuffs = new("odinsnummies", "OH_JotunPuffs");
            OH_JotunPuffs.Name.English("JotunPuffs Basket");
            OH_JotunPuffs.Description.English("A basket of JotunPuffs");
            OH_JotunPuffs.RequiredItems.Add("MushroomJotunpuffs", 50, true);
            OH_JotunPuffs.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Magecap.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_RoyalJelly.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Sap_Barrel.Category.Add(BuildPieceCategory.Misc);
            ...
            OH_Seedbag.Category.Add(BuildPieceCategory.Misc);
